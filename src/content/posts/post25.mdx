...
Developing a game for MoldOS involves writing custom graphics drivers to manipulate the VGA buffer directly. The standard text mode provides an 80x25 character grid, but with some tweaking, I've managed to create a more graphical environment for the game.
