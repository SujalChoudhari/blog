...
The design work happens in the editing phase: you take the generated volume and impose constraints. You delete unnecessary assets, adjust sightlines, modify the terrain so that it dictates movement, and ensure that every object justifies its existence. You add causality.
